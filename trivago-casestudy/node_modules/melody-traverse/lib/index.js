...
function explode(visitor) {
    ...
    for (var _iterator = Object.getOwnPropertyNames(visitor), _isArray = Array.isArray(_iterator), _i = 0, _iterator = _isArray ? _iterator : _iterator[Symbol.iterator]();;) {
        ...
        var fns = visitor[_key];
        if (typeof fns === 'function') {
            fns = visitor[_key] = { enter: fns };
        }
    ...
    for (; j < visitorKeyLength; j++) {
        var key = visitorKeys[j];
        // manage aliases
        if (melodyTypes.ALIAS_TO_TYPE[key]) {
            var i = 0;
            for (var types = melodyTypes.ALIAS_TO_TYPE[key], len = types.length; i < len; i++) {
                var type = types[i];
                if (!visitor[type]) {
                    visitor[type] = { enter: [] };
                }
                if (visitor[key].enter) {
                    ...
                    (_visitor$type$enter = visitor[type].enter).push.apply(_visitor$type$enter, visitor[key].enter);
                }
                if (visitor[key].exit) {
                    ...
                    (_visitor$type$exit = visitor[type].exit).push.apply(_visitor$type$exit, visitor[key].exit);
                }
            }
            delete visitor[key];
        }
...
var TraversalContext = function () {
    function TraversalContext(scope, visitor, state, parentPath) {
        _classCallCheck$1(this, TraversalContext);
...
var Binding = function () {
    function Binding(identifier, scope, path) {
        ...
        _classCallCheck$3(this, Binding);
...
var Scope = function () {
    ...
    Scope.get = function get(path, parentScope) {
...
var Path = function () {
    ...
    Path.prototype.get = function get(key) {
        var _this = this;
