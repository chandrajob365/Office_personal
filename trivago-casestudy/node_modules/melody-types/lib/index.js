...
function is$1(node, type) {
    return node && (node.type === type || IS_ALIAS_OF[type] && IS_ALIAS_OF[type][node.type] || t.is(node, type));
}
...
var Fragment = function (_Node) {
    ...
    function Fragment(expression) {
        ...
        var _this2 = _possibleConstructorReturn(this, _Node.call(this));
...
var PrintExpressionStatement = function (_Node2) {
    _inherits(PrintExpressionStatement, _Node2);

    function PrintExpressionStatement(expression) {
        _classCallCheck(this, PrintExpressionStatement);

        var _this3 = _possibleConstructorReturn(this, _Node2.call(this));
...
var PrintTextStatement = function (_Node3) {
    _inherits(PrintTextStatement, _Node3);

    function PrintTextStatement(text) {
        _classCallCheck(this, PrintTextStatement);

        var _this4 = _possibleConstructorReturn(this, _Node3.call(this));
...
var ConstantValue = function (_Node4) {
    _inherits(ConstantValue, _Node4);

    function ConstantValue(value) {
        _classCallCheck(this, ConstantValue);

        var _this5 = _possibleConstructorReturn(this, _Node4.call(this));
...
var StringLiteral = function (_ConstantValue) {
    _inherits(StringLiteral, _ConstantValue);

    function StringLiteral() {
        _classCallCheck(this, StringLiteral);

        return _possibleConstructorReturn(this, _ConstantValue.apply(this, arguments));
    }
...
var NumericLiteral = function (_ConstantValue2) {
    _inherits(NumericLiteral, _ConstantValue2);

    function NumericLiteral() {
        _classCallCheck(this, NumericLiteral);

        return _possibleConstructorReturn(this, _ConstantValue2.apply(this, arguments));
    }
...
var BooleanLiteral = function (_ConstantValue3) {
    _inherits(BooleanLiteral, _ConstantValue3);

    function BooleanLiteral(value) {
        _classCallCheck(this, BooleanLiteral);

        return _possibleConstructorReturn(this, _ConstantValue3.call(this, value));
    }
...
var NullLiteral = function (_ConstantValue4) {
    _inherits(NullLiteral, _ConstantValue4);

    function NullLiteral() {
        _classCallCheck(this, NullLiteral);

        return _possibleConstructorReturn(this, _ConstantValue4.call(this, null));
    }
...
var Identifier = function (_Node5) {
    _inherits(Identifier, _Node5);

    function Identifier(name) {
        _classCallCheck(this, Identifier);

        var _this10 = _possibleConstructorReturn(this, _Node5.call(this));
...
var UnaryExpression = function (_Node6) {
    _inherits(UnaryExpression, _Node6);

    function UnaryExpression(operator, argument) {
        _classCallCheck(this, UnaryExpression);

        var _this11 = _possibleConstructorReturn(this, _Node6.call(this));
...
var BinaryExpression = function (_Node7) {
    _inherits(BinaryExpression, _Node7);

    function BinaryExpression(operator, left, right) {
        _classCallCheck(this, BinaryExpression);

        var _this12 = _possibleConstructorReturn(this, _Node7.call(this));
...
var BinaryConcatExpression = function (_BinaryExpression) {
    _inherits(BinaryConcatExpression, _BinaryExpression);

    function BinaryConcatExpression(left, right) {
        _classCallCheck(this, BinaryConcatExpression);

        return _possibleConstructorReturn(this, _BinaryExpression.call(this, '~', left, right));
    }
...
var ConditionalExpression = function (_Node8) {
    _inherits(ConditionalExpression, _Node8);

    function ConditionalExpression(test, consequent, alternate) {
        _classCallCheck(this, ConditionalExpression);

        var _this14 = _possibleConstructorReturn(this, _Node8.call(this));
...
var ArrayExpression = function (_Node9) {
    _inherits(ArrayExpression, _Node9);
    ...
    function ArrayExpression() {
        ...
        var _this15 = _possibleConstructorReturn(this, _Node9.call(this));
...
var MemberExpression = function (_Node10) {
    _inherits(MemberExpression, _Node10);

    function MemberExpression(object, property, computed) {
        _classCallCheck(this, MemberExpression);

        var _this16 = _possibleConstructorReturn(this, _Node10.call(this));
...
var CallExpression = function (_Node11) {
    _inherits(CallExpression, _Node11);

    function CallExpression(callee, args) {
        _classCallCheck(this, CallExpression);

        var _this17 = _possibleConstructorReturn(this, _Node11.call(this));
...
var NamedArgumentExpression = function (_Node12) {
    _inherits(NamedArgumentExpression, _Node12);

    function NamedArgumentExpression(name, value) {
        _classCallCheck(this, NamedArgumentExpression);

        var _this18 = _possibleConstructorReturn(this, _Node12.call(this));
...
var ObjectExpression = function (_Node13) {
    _inherits(ObjectExpression, _Node13);
    ...
    function ObjectExpression() {
        ...
        var _this19 = _possibleConstructorReturn(this, _Node13.call(this));
...
var ObjectProperty = function (_Node14) {
    _inherits(ObjectProperty, _Node14);

    function ObjectProperty(key, value, computed) {
        _classCallCheck(this, ObjectProperty);

        var _this20 = _possibleConstructorReturn(this, _Node14.call(this));
...
var SequenceExpression = function (_Node15) {
    _inherits(SequenceExpression, _Node15);

    function SequenceExpression() {
        var expressions = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : [];

        _classCallCheck(this, SequenceExpression);

        var _this21 = _possibleConstructorReturn(this, _Node15.call(this));
...
var SliceExpression = function (_Node16) {
    _inherits(SliceExpression, _Node16);

    function SliceExpression(target, start, end) {
        _classCallCheck(this, SliceExpression);

        var _this22 = _possibleConstructorReturn(this, _Node16.call(this));
...
var FilterExpression = function (_Node17) {
    _inherits(FilterExpression, _Node17);

    function FilterExpression(target, name, args) {
        _classCallCheck(this, FilterExpression);

        var _this23 = _possibleConstructorReturn(this, _Node17.call(this));
...
var Element = function (_Node18) {
    _inherits(Element, _Node18);

    function Element(name) {
        _classCallCheck(this, Element);

        var _this24 = _possibleConstructorReturn(this, _Node18.call(this));
...
var Attribute = function (_Node19) {
    ...
    function Attribute(name) {
        ...
        var _this25 = _possibleConstructorReturn(this, _Node19.call(this));
