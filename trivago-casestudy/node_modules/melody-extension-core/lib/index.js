...
function createTest(text, typeName) {
    var TestExpression = function (_Node) {
        _inherits(TestExpression, _Node);

        function TestExpression(expr, args) {
            _classCallCheck(this, TestExpression);
...
function createBinaryOperatorNode(options) {
    ...
    var BinarySubclass = function (_BinaryExpression) {
        _inherits(BinarySubclass, _BinaryExpression);

        function BinarySubclass(left, right) {
            _classCallCheck(this, BinarySubclass);

            return _possibleConstructorReturn(this, _BinaryExpression.call(this, text, left, right));
        }
...
function createUnaryOperator(operator, typeName, precedence) {
    var UnarySubclass = function (_UnaryExpression) {
        _inherits(UnarySubclass, _UnaryExpression);

        function UnarySubclass(argument) {
            _classCallCheck(this, UnarySubclass);

            return _possibleConstructorReturn(this, _UnaryExpression.call(this, operator, argument));
        }
...
var AutoescapeBlock = function (_Node) {
    _inherits$1(AutoescapeBlock, _Node);

    function AutoescapeBlock(type$$1, expressions) {
        _classCallCheck$1(this, AutoescapeBlock);
...
var BlockStatement = function (_Node2) {
    _inherits$1(BlockStatement, _Node2);

    function BlockStatement(name, body) {
        _classCallCheck$1(this, BlockStatement);

        var _this2 = _possibleConstructorReturn$1(this, _Node2.call(this));
...
var BlockCallExpression = function (_Node3) {
    _inherits$1(BlockCallExpression, _Node3);

    function BlockCallExpression(callee) {
        var args = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : [];

        _classCallCheck$1(this, BlockCallExpression);

        var _this3 = _possibleConstructorReturn$1(this, _Node3.call(this));
...
var MountStatement = function (_Node4) {
    _inherits$1(MountStatement, _Node4);

    function MountStatement(name, source, key, argument) {
        _classCallCheck$1(this, MountStatement);

        var _this4 = _possibleConstructorReturn$1(this, _Node4.call(this));
...
melodyTypes.alias(MountStatement, 'Statement');
melodyTypes.visitor(MountStatement, 'name', 'source', 'key', 'argument');

var DoStatement = function (_Node5) {
    _inherits$1(DoStatement, _Node5);

    function DoStatement(expression) {
        _classCallCheck$1(this, DoStatement);

        var _this5 = _possibleConstructorReturn$1(this, _Node5.call(this));
...
var EmbedStatement = function (_Node6) {
    _inherits$1(EmbedStatement, _Node6);

    function EmbedStatement(parent) {
        _classCallCheck$1(this, EmbedStatement);

        var _this6 = _possibleConstructorReturn$1(this, _Node6.call(this));
...
var ExtendsStatement = function (_Node7) {
    _inherits$1(ExtendsStatement, _Node7);

    function ExtendsStatement(parentName) {
        _classCallCheck$1(this, ExtendsStatement);

        var _this7 = _possibleConstructorReturn$1(this, _Node7.call(this));
...
var FilterBlockStatement = function (_Node8) {
    _inherits$1(FilterBlockStatement, _Node8);

    function FilterBlockStatement(filterExpression, body) {
        _classCallCheck$1(this, FilterBlockStatement);

        var _this8 = _possibleConstructorReturn$1(this, _Node8.call(this));
...
var FlushStatement = function (_Node9) {
    _inherits$1(FlushStatement, _Node9);

    function FlushStatement() {
        _classCallCheck$1(this, FlushStatement);

        return _possibleConstructorReturn$1(this, _Node9.call(this));
    }
...
var ForStatement = function (_Node10) {
    _inherits$1(ForStatement, _Node10);
    ...
    function ForStatement() {
        ...
        var _this10 = _possibleConstructorReturn$1(this, _Node10.call(this));
...
var ImportDeclaration = function (_Node11) {
    _inherits$1(ImportDeclaration, _Node11);

    function ImportDeclaration(key, alias$$1) {
        _classCallCheck$1(this, ImportDeclaration);

        var _this11 = _possibleConstructorReturn$1(this, _Node11.call(this));
...
var FromStatement = function (_Node12) {
    _inherits$1(FromStatement, _Node12);

    function FromStatement(source, imports) {
        _classCallCheck$1(this, FromStatement);

        var _this12 = _possibleConstructorReturn$1(this, _Node12.call(this));
...
var IfStatement = function (_Node13) {
    _inherits$1(IfStatement, _Node13);
    ...
    function IfStatement(test) {
        ...
        var _this13 = _possibleConstructorReturn$1(this, _Node13.call(this));
...
var IncludeStatement = function (_Node14) {
    _inherits$1(IncludeStatement, _Node14);

    function IncludeStatement(source) {
        _classCallCheck$1(this, IncludeStatement);

        var _this14 = _possibleConstructorReturn$1(this, _Node14.call(this));
...
var MacroDeclarationStatement = function (_Node15) {
    _inherits$1(MacroDeclarationStatement, _Node15);

    function MacroDeclarationStatement(name, args, body) {
        _classCallCheck$1(this, MacroDeclarationStatement);

        var _this15 = _possibleConstructorReturn$1(this, _Node15.call(this));
...
var VariableDeclarationStatement = function (_Node16) {
    _inherits$1(VariableDeclarationStatement, _Node16);

    function VariableDeclarationStatement(name, value) {
        _classCallCheck$1(this, VariableDeclarationStatement);

        var _this16 = _possibleConstructorReturn$1(this, _Node16.call(this));
...
var SetStatement = function (_Node17) {
    _inherits$1(SetStatement, _Node17);

    function SetStatement(assignments) {
        _classCallCheck$1(this, SetStatement);

        var _this17 = _possibleConstructorReturn$1(this, _Node17.call(this));
...
var SpacelessBlock = function (_Node18) {
    _inherits$1(SpacelessBlock, _Node18);

    function SpacelessBlock() {
        var body = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : null;

        _classCallCheck$1(this, SpacelessBlock);

        var _this18 = _possibleConstructorReturn$1(this, _Node18.call(this));
...
var AliasExpression = function (_Node19) {
    _inherits$1(AliasExpression, _Node19);

    function AliasExpression(name, alias$$1) {
        _classCallCheck$1(this, AliasExpression);

        var _this19 = _possibleConstructorReturn$1(this, _Node19.call(this));
...
var UseStatement = function (_Node20) {
    _inherits$1(UseStatement, _Node20);

    function UseStatement(source, aliases) {
        _classCallCheck$1(this, UseStatement);

        var _this20 = _possibleConstructorReturn$1(this, _Node20.call(this));
...
var BlockParser = {
    ...
    parse: function parse(parser, token) {
        ...
        if (tokens.nextIf(melodyParser.Types.TAG_END)) {
            blockStatement$$1 = new BlockStatement(melodyParser.createNode(melodyTypes.Identifier, nameToken, nameToken.text), parser.parse(function (tokenText, token, tokens) {
                return !!(token.type === melodyParser.Types.TAG_START && tokens.nextIf(melodyParser.Types.SYMBOL, 'endblock'));
            }).expressions);
            ...
            blockStatement$$1 = new BlockStatement(melodyParser.createNode(melodyTypes.Identifier, nameToken, nameToken.text), new melodyTypes.PrintExpressionStatement(parser.matchExpression()));
        }

        melodyParser.setStartFromToken(blockStatement$$1, token);
        melodyParser.setEndFromToken(blockStatement$$1, tokens.expect(melodyParser.Types.TAG_END));
...
var EmbedParser = {
    ...
    parse: function parse(parser, token) {
        ...
        embedStatement.blocks = _filter(parser.parse(function (tokenText, token, tokens) {
            return !!(token.type === melodyParser.Types.TAG_START && tokens.nextIf(melodyParser.Types.SYMBOL, 'endembed'));
...
var FilterParser = {
    ...
    parse: function parse(parser, token) {
        ...
        var body = parser.parse(function (text, token, tokens) {
            return token.type === melodyParser.Types.TAG_START && tokens.nextIf(melodyParser.Types.SYMBOL, 'endfilter');
        }).expressions;
...
var ForParser = {
    ...
    parse: function parse(parser, token) {
        ...
        forStatement.body = parser.parse(function (tokenText, token, tokens) {
            return token.type === melodyParser.Types.TAG_START && (tokens.test(melodyParser.Types.SYMBOL, 'else') || tokens.test(melodyParser.Types.SYMBOL, 'endfor'));
        });
    ...
    parse: function parse(parser, token) {
        ...
        do {
            ...
            if (tokens.nextIf(melodyParser.Types.SYMBOL, 'as')) {
                alias$$1 = tokens.expect(melodyParser.Types.SYMBOL);
            }

            var importDeclaration$$1 = new ImportDeclaration(melodyParser.createNode(melodyTypes.Identifier, name, name.text), melodyParser.createNode(melodyTypes.Identifier, alias$$1, alias$$1.text));
            melodyParser.setStartFromToken(importDeclaration$$1, name);
            melodyParser.setEndFromToken(importDeclaration$$1, alias$$1);
...
var IfParser = {
    ...
    parse: function parse(parser, token) {
        ...
        melodyParser.setStartFromToken(ifStatement$$1, token);
        melodyParser.setEndFromToken(ifStatement$$1, tokens.expect(melodyParser.Types.TAG_END));
...
var ImportParser = {
    ...
    parse: function parse(parser, token) {
        ...
        var alias$$1 = tokens.expect(melodyParser.Types.SYMBOL);

        var importStatement = new ImportDeclaration(source, melodyParser.createNode(melodyTypes.Identifier, alias$$1, alias$$1.text));
...
var MacroParser = {
    ...
    parse: function parse(parser, token) {
        ...
        var body = parser.parse(function (tokenText, token, tokens) {
            return !!(token.type === melodyParser.Types.TAG_START && tokens.nextIf(melodyParser.Types.SYMBOL, 'endmacro'));
        });
    ...
    parse: function parse(parser, token) {
        ...
        if (tokens.nextIf(melodyParser.Types.ASSIGNMENT)) {
            ...
            values[0] = parser.parse(function (tokenText, token, tokens) {
                return !!(token.type === melodyParser.Types.TAG_START && tokens.nextIf(melodyParser.Types.SYMBOL, 'endset'));
            }).expressions;
        }
...
var SpacelessParser = {
    ...
    parse: function parse(parser, token) {
        ...
        var body = parser.parse(function (tokenText, token, tokens) {
            return !!(token.type === melodyParser.Types.TAG_START && tokens.nextIf(melodyParser.Types.SYMBOL, 'endspaceless'));
        }).expressions;
        ...
        if (tokens.nextIf(melodyParser.Types.SYMBOL, 'with')) {
            do {
                ...
                if (tokens.nextIf(melodyParser.Types.SYMBOL, 'as')) {
                    ...
                    alias$$1 = melodyParser.createNode(melodyTypes.Identifier, aliasToken, aliasToken.text);
                }
                var aliasExpression = new AliasExpression(name, alias$$1);
                melodyParser.copyStart(aliasExpression, name);
                melodyParser.copyEnd(aliasExpression, alias$$1);
...
var MountParser = {
    ...
    parse: function parse(parser, token) {
        ...
        var mountStatement = new MountStatement(name, source, key, argument);
...
var filters = {
    ...
    trim: function trim(path) {
        path.replaceWithJS(t.callExpression(t.memberExpression(path.node.target, t.identifier('trim')), path.node.arguments));
    },
 ...
 * limitations under the License.
 */
var filterMap = ['attrs', 'classes', 'styles', 'batch', 'escape', 'format', 'merge', 'nl2br', 'number_format', 'raw', 'replace', 'reverse', 'round', 'striptags', 'title', 'url_encode'].reduce(function (map, filterName) {
